...
public class JSGLR2<ParseForest extends AbstractParseForest, AbstractSyntaxTree> {
    ...
    @SuppressWarnings("unchecked") public static JSGLR2<HybridParseForest, IStrategoTerm> naive(IParseTable parseTable)
        throws ParseTableReadException {
        return (JSGLR2<HybridParseForest, IStrategoTerm>) JSGLR2Variants.getJSGLR2(parseTable,
            new ParserVariant(ActiveStacksRepresentation.ArrayList, ForActorStacksRepresentation.ArrayDeque,
                ParseForestRepresentation.Basic, ParseForestConstruction.Optimized, StackRepresentation.Basic,
                Reducing.Basic));
    }
    ...
    public ParseForest parseUnsafeNoImploding(String input) throws ParseException {
        return parseUnsafeNoImploding(input, "", null);
    }

    private ParseForest parseUnsafeNoImploding(String input, String filename, String startSymbol)
